...
длительного изучения (Android Jetpack, Koin, Coroutines). Принципы Clean Architecture придерживаются, но не строго и без фанатизма, не в ущерб производительности (без абстракций ради абстракций).
