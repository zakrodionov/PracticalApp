...
import com.zakrodionov.common.ui.rv.DiffAdapterCallback
...
class FragmentListAdapter<T : FragmentTab> internal constructor(
    ...
    /*
    * FragmentStateAdapter uses item IDs to determine if a fragment has already been created and
    * reuses already created ones. To update the item correctly, the ID must change if the content has changed.
    * ¯\_(ツ)_/¯ It's Google
    * */
